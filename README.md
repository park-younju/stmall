...
## Model
www.msaez.io/#/194867567/storming/011ed26abb918df741770359a3f9d3ef
...
- delivery
```
 http :8088/deliveries id="id"procuctId="procuctId"productName="productName"qty="qty"status="status"address="address"
```
- product
```
